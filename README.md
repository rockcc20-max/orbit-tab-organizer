...
以下截图使用内置示例数据，不包含真实用户的浏览记录。安装后会显示你自己打开的选项卡。

### 按网站汇总

网站 Logo、名称和页面列表集中展示，可以搜索并快速切换页面。

![Orbit 网站汇总界面，展示 YouTube、Figma 和 GitHub 的示例选项卡](docs/screenshots/overview.jpg)

### 选择重复选项卡

筛选重复页面，勾选需要关闭的项目，再点击“关闭选中项”确认清理。

![Orbit 重复选项卡界面，展示勾选重复页面后的状态](docs/screenshots/duplicates.jpg)
